...
#define COMPILER_FEATURE_ENTRY(name) { #name, COMPILER_FEATURE_VALUE(name) },//先解析后替换? 你你你你你你你你你你你你你你你你你你你   
...
void show_msvc_attributes_test()
{
#define prt_attr_support(V) std::cout<<std::setw(45)<<#V<<": support\n";
#define prt_attr_not_support(V) std::cout<<std::setw(45)<<#V<<": not support\n"; 
    std::cout << "\n test support c++ attributes:\n";
#if __has_cpp_attribute(carries_dependency)
    prt_attr_support(carries_dependency)
#else
    prt_attr_not_support(carries_dependency)
#endif
#if __has_cpp_attribute(deprecated)
        prt_attr_support(deprecated)
#else
        prt_attr_not_support(deprecated)
#endif
#if __has_cpp_attribute(fallthrough)
        prt_attr_support(fallthrough)
#else
        prt_attr_not_support(fallthrough)
#endif
#if __has_cpp_attribute(likely)
        prt_attr_support(likely)
#else
        prt_attr_not_support(likely)
#endif
#if __has_cpp_attribute(maybe_unused)
        prt_attr_support(maybe_unused)
#else
        prt_attr_not_support(maybe_unused)
#endif
#if __has_cpp_attribute(no_unique_address)
        prt_attr_support(no_unique_address)
#else
        prt_attr_not_support(no_unique_address)
#endif
#if __has_cpp_attribute(nodiscard)
        prt_attr_support(nodiscard)
#else
        prt_attr_not_support(nodiscard)
#endif
#if __has_cpp_attribute(noreturn)
        prt_attr_support(noreturn)
#else
        prt_attr_not_support(noreturn)
#endif
#if __has_cpp_attribute(unlikely)
        prt_attr_support(unlikely)
#else
        prt_attr_not_support(unlikely)
#endif
}
